...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: "Speed up an educational Android app by 35% by optimizing code and database queries. Built key features like login and video streaming, which boosted user engagement by 22%. Made the app more stable by fixing bugs and reducing crashes.",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-stretch">
              ...
              <div className="flex-grow flex flex-col">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-grow">
                  {competitiveProfiles.map((profile, index) => (
                      <a key={index} href={profile.url} target="_blank" rel="noopener noreferrer" className="block h-full">
                        <Card className="p-4 bg-card border-border text-center hover:bg-secondary transition-colors h-full flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-12 h-full">
              ...
              <div className="flex-grow flex flex-col">
                ...
                <Card className="p-7 bg-card border-border flex-grow flex flex-col justify-center">
